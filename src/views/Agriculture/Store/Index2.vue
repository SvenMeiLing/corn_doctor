<template>
    <n-layout embedded class="p-[20px] h-full">
        <n-grid cols="20" item-responsive responsive="screen">
            <n-grid-item span="8" class="bg-red-400">
                <n-card class="w-full h-full" content-class="p-2">
        ...
        <n-grid cols="20" item-responsive responsive="screen">
            <n-grid-item span="8" class="bg-zinc-200">

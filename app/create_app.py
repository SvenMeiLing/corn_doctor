...
def create_app(test_config=None):
    # 创建和配置app程序
    app = Flask(__name__, template_folder=TEMPLATE_HOLDER, static_folder=STATIC_FOLDER)
    ...
    fileupload_bp.add_url_rule("/image", view_func=UpLoadFile.as_view("image"))
    fileupload_bp.add_url_rule("/video", view_func=UpLoadFile.as_view("video"))
    fileupload_bp.add_url_rule("/video_player", view_func=UpLoadFile.as_view("video_player"))
